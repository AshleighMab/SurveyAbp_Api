...
{
    public abstract class SurveyAbp_ApiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SurveyAbp_ApiWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SurveyAbp_ApiWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SurveyAbp_ApiDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SurveyAbp_ApiDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SurveyAbp_ApiDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SurveyAbp_ApiDbContext, Task<T>> func)
        {
            T result;
