...
namespace SurveyAbp_Api.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = SurveyAbp_ApiConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(SurveyAbp_ApiDbContext context)
        {
            _context = context;
        }
